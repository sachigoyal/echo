...
```tsx
import { EchoProvider } from '@echo-systems/react-sdk';

function App() {
  return (
    <EchoProvider
      config={{
        instanceId: 'your-echo-instance-id',
...
```tsx
import { useEcho } from '@echo-systems/react-sdk';
...
Users can purchase tokens using the EchoTokenPurchase component, which:
...
- `instanceId` (required): Your Echo instance identifier
