...
<AutoTypeTable
  path="src/services/apps/get.ts"
  type={`NonNullable<Awaited<ReturnType<typeof getApp>>>`}
/>
...
<AutoTypeTable path="src/lib/balance/types.ts" name="Balance" />

For app-specific balance queries, returns:

<AutoTypeTable path="src/lib/balance/types.ts" name="AppBalance" />
...
<AutoTypeTable path="src/lib/spend-pools/types.ts" name="UserSpendInfo" />
