...
export default async function Header() {
  ...
  return (
    <header className="bg-card border-b border-border/50 shadow-sm fixed top-0 left-0 right-0 z-50 h-12 md:h-16 flex items-center justify-between px-2 md:px-4">
