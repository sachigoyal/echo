...
// GET /api/owner/apps - List echo apps owned by authenticated user
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching owner echo apps:', error);
...
// POST /api/owner/apps - Create a new echo app for the authenticated user
