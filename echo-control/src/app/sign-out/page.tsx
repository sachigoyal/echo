        ...
        <div className="bg-card rounded-lg border border-border p-6 shadow-lg">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Link
                href="/"
                className="block w-full bg-secondary hover:bg-secondary/80 text-secondary-foreground font-medium py-3 px-4 rounded-lg transition-colors text-center focus:outline-hidden focus:ring-2 focus:ring-secondary focus:ring-offset-2 focus:ring-offset-background"
              >
                Cancel
              </Link>
            </div>
