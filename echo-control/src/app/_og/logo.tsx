...
export const Logo = ({ tw }: LogoProps) => {
  return (
    <svg
      id="Layer_2"
      data-name="Layer 2"
    ...
    >
      <g clipPath="url(#clippath)">
        <g id="Layer_1-2" data-name="Layer 1-2">
          <g fill="none" stroke="#e5e5e5" strokeWidth="16" strokeOpacity="0.5">
          ...
          <g fill="none" stroke="#e5e5e5" strokeWidth="12" strokeOpacity="0.4">
          ...
          <g fill="none" stroke="#e5e5e5" strokeWidth="8" strokeOpacity="0.3">
