  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "pulse-shadow": {
          "0%, 12.5%, 37.5%, 100%": { 
            boxShadow: "0 0 var(--pulse-shadow-start, 8px) rgb(var(--secondary))"
          },
          "25%": { 
            boxShadow: "0 0 var(--pulse-shadow-end, 24px) rgb(var(--secondary))"
          },
        },
        "border-pulse": {
          "0%, 100%": { 
      ...
      animation: {
        ...
        "pulse-shadow": "pulse-shadow var(--pulse-shadow-duration, 3s) ease-in-out var(--pulse-shadow-delay, 0s) infinite",
