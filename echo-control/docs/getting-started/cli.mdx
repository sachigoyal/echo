...
<Steps>
    ...
    <Step>
        ### Create Echo App
        Go to [echo.merit.systems/owner/apps/create](https://echo.merit.systems/owner/apps/create) to get your `app_id`.
    </Step>
    ...
    <Step>
        ...
        await open(`https://echo.merit.systems/cli-auth/${APP_ID}`);
