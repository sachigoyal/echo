...
<Steps>
    ...
    <Step>
        ### Setup your Echo App
        1. In the Echo dashboard navigate to [**Create App**](https://echo.merit.systems/owner/apps/create). 
    ...
    <Step>
        ...
        Visit your apps' homepage at [`http://localhost:5173`](http://localhost:5173). Sign in and click "Generate Wisdom".
    </Step>
