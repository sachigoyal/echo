...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">```bash npm install @merit-systems/echo-next-sdk ```</Tab>
  <Tab value="pnpm">```bash pnpm add @merit-systems/echo-next-sdk ```</Tab>
  <Tab value="yarn">```bash yarn add @merit-systems/echo-next-sdk ```</Tab>
  <Tab value="bun">```bash bun add @merit-systems/echo-next-sdk ```</Tab>
</Tabs>
